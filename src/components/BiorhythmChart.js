    ...
    return (
        <ResponsiveContainer className="biorhythm-chart" width="100%" height={200}>
            <LineChart data={data}>
                ...
                <Line type="natural" dot={false} dataKey="physical" className="physical" stroke="green"/>
                <Line type="natural" dot={false} dataKey="emotional" className="emotional"/>
                <Line type="natural" dot={false} dataKey="intellectual" className="intellectual" stroke="blue"/>
            </LineChart>
        </ResponsiveContainer>
    );
}
